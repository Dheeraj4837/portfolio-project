...
const Page2 = () => {
  ...
  return (
    <div id="section2" className="bg-white text-center p-10 text-black">
      <h3 className="text-gray-500 text-xl font-[Anim3]">
        © anzo.studio 2024 | designed and developed
      </h3>
      <div className="rotateText mt-20">
        <h1 className="text-[42vw] text-black font-[Anim5] uppercase leading-[32vw]">
          IMPACTFUL
        </h1>
      </div>
      ...
      <div className="rotateText">
        <h1 className="text-[55vw] text-black font-[Anim5] uppercase leading-[40vw]">
          WORK
        </h1>
      </div>
      ...
      <div className="h-[2px] w-1/3 relative left-1/2 -translate-x-1/2 bg-black mt-2"></div>
    </div>
  );
};
